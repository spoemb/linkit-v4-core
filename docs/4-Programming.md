...
> **Note:** The merged hex is only generated if the bootloader has been built first. See [Developer Quick Start - Build the Bootloader](2-Developer-Quick-Start.md#4-build-the-bootloader-first-time-only).
...
See [DTE Commands Reference](https://github.com/arribada/linkit-v4-core/wiki/6-%E2%80%90-DTE-commands) for the full protocol specification and command set.
...
- [DTE Commands Reference](https://github.com/arribada/linkit-v4-core/wiki/6-%E2%80%90-DTE-commands) — Full protocol and command documentation
- [Architecture Overview](https://github.com/arribada/linkit-v4-core/wiki/7-%E2%80%90-Architecture) — Firmware design and service model
- [Application Behavior](https://github.com/arribada/linkit-v4-core/wiki/11-%E2%80%90-LinkIt-UW-Behavior) — Underwater mode, RSPB duty cycling, SWS algorithm