...
#define I2C_RECOVERY_MAX_ATTEMPTS 3
...
public:
	...
	// Throwing versions (legacy API) - throw ErrorCode on failure
	...
	// Non-throwing versions - return true on success, false on failure
	// Use these when you want the application to continue on I2C failure
	...
	// Recovery function - can be called externally if needed
