...
#define SMD_VPA_PIN          BSP::GPIO::GPIO_SMD_VPA
...
// Debug UART on SWO pin (P0.11)
#define DEBUG_UART_TX_PIN    NRF_GPIO_PIN_MAP(0, 11)
...
#define BMA400_ADDRESS            0x14  // SDO->GND=0x14
...
// Note: EXTERNAL_WAKEUP is defined via CMakeLists.txt for RSPB board
#define NO_BAT_GAUGE
