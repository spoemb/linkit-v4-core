...
namespace BSP
{
	...
	const GPIO_InitTypeDefAndInst_t GPIO_Inits[GPIO_TOTAL_NUMBER] =
	{
        ...
        /* GPIO_SAT_INT         */ {NRF_GPIO_PIN_MAP(0, 29), NRF_GPIO_PIN_DIR_INPUT,  NRF_GPIO_PIN_INPUT_CONNECT,    NRF_GPIO_PIN_NOPULL, NRF_GPIO_PIN_S0S1, NRF_GPIO_PIN_NOSENSE, {}},  // GPIOTE disabled: same pin as GPIO_SMD_INT — avoid double registration
    ...
    const SPI_InitTypeDefAndInst_t SPI_Inits[SPI_TOTAL_NUMBER] =
    {
    ...
    #if NRFX_SPIM2_ENABLED
        {
            ...
            .config = {
                ...
                .orc = 0xFF, // Over-run character
                .frequency = NRF_SPIM_FREQ_125K,  // STM32WL Protocol A+ requires ≤125K (DMA re-arm timing)
                .mode = NRF_SPIM_MODE_0,
                .bit_order = NRF_SPIM_BIT_ORDER_MSB_FIRST
            }
        },
