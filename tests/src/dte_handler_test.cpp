...
TEST(DTEHandler, PARMR_REQ_CheckEmptyRequest)
{
	...
	// Checksum updated from #6EF → #71C → #728 → #744 → #780 → #788 → #780 → #792
	// (+ARP36 ARGOS_TX_NO_FIX_POLICY=0, +ARP37 ARGOS_LAST_KNOWN_MAX_AGE_S=86400; +20 bytes).
