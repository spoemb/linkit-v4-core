...
TEST(DTEHandler, PARMR_UNP_NewParams)
{
	...
	CHECK_TRUE(DTEAction::NONE == dte_handler->handle_dte_message(req, resp));
	// "UNP04=10,UNP05=1,UNP22=4,UNP25=2" = 32 chars = 0x20
	STRCMP_EQUAL("$O;PARMR#020;UNP04=10,UNP05=1,UNP22=4,UNP25=2\r", resp.c_str());
}
